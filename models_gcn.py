...
class GCN(nn.Module):
    def __init__(self, nfeat, nhid, nclass, dropout):
        ...
        #print('gc1: ', self.gc1.weight.shape, self.gc1.bias.shape) # gc1:  torch.Size([35, 64]) torch.Size([64])
        self.gc2 = GraphConvolution(nhid, nclass)
        #print('gc2: ', self.gc2.weight.shape, self.gc2.bias.shape) # gc2:  torch.Size([64, 2]) torch.Size([2])
